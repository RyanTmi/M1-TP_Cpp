...
bool load_data_from_file(std::vector<card>& datas, const char* fileName);
void print_analysis(const analysis_result& analisysResult);

void analysis(const std::vector<card>& datas, analysis_result& analisysResult);
void algorithm_analysis(const std::vector<card>& datas, analysis_result& analisysResult);
